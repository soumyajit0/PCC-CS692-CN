...
int main(){
	...
	while(running==1){
		...
		if (n==-1){
			...
			msgsnd(msgid,(void*)&message1,sizeof(message1.message_body),0);
			
			struct message_struct message2;
			message2.message_type=2;
			strcpy(message2.message_body,"end");
			msgsnd(msgid,(void*)&message2,sizeof(message2.message_body),0);
			
			struct message_struct message3;
			message3.message_type=3;
			strcpy(message3.message_body,"end");
			msgsnd(msgid,(void*)&message3,sizeof(message3.message_body),0);
