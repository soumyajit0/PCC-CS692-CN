...
int main(int argc,char **argv)
{
  ...
  while(1)
  {
    ...
    recvfrom(sid,(void *)&message,sizeof(message),0,(struct sockaddr *)&caddr,&len);
    ...
    sendto(sid,(void *)&message,sizeof(message),0,(struct sockaddr *)&caddr,sizeof(caddr));
  }
}
